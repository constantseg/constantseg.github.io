...
- Caméra infrarouge + bouton poussoir
- Interface graphique (icône de verrou, retour caméra)
...
|----------|-------------------------|
| **Systèmes** | Linux (Arch, Debian, RPi OS), virtualisation (Proxmox, QEMU/KVM) |
| **Réseaux** | Cisco Packet Tracer, VLAN, LACP, QoS |
| **Programmation** | Python, HTML/CSS, Bash, C++ |
| **Électronique** | Raspberry Pi, Arduino, capteurs, relais |
| **Cybersécurité** | Surveillance réseau, analyse de vulnérabilités, scripts de sécurité |
